...
history_dir = r"C:\Users\AANU\AppData\Roaming\Cursor\User\History"

print(f"Scanning {history_dir} for content matches...")
    ...
    for root, dirs, files in os.walk(history_dir):
        if "entries.json" in files:
            ...
            try:
                ...
                if "bloomncuddles" in decoded.lower() and "test/page.tsx" in decoded.lower():
