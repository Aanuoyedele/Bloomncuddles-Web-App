...
export default function TestPage() {
    ...
    return (
        <div className="overflow-x-hidden">
            ...
            <section className="relative min-h-[92vh] flex items-center overflow-hidden bg-[#0f2854]">
                ...
                <div className="absolute inset-0 pointer-events-none overflow-hidden">
                    ...
                    {/* Linear grid pattern */}
                    <div className="absolute inset-0 opacity-[0.05]" style={{ backgroundImage: 'repeating-linear-gradient(0deg, transparent, transparent 69px, white 69px, white 70px), repeating-linear-gradient(90deg, transparent, transparent 69px, white 69px, white 70px)', backgroundSize: '70px 70px' }} />
                    {/* Abstract SVG shapes */}
